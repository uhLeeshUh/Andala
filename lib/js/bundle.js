...
document.addEventListener('DOMContentLoaded', () => {
  new _canvas__WEBPACK_IMPORTED_MODULE_0__["default"]('andala-canvas');
});
...
class Canvas {
  ...
  setDrawingEventListeners() {
    ...
    this.canvasElement.addEventListener('touchstart', (e) => this.setDrawingParameters('DOWN', e.touches[0]));
    this.canvasElement.addEventListener('touchend', (e) => this.setDrawingParameters('UP', e.touches[0]));
    this.canvasElement.addEventListener('touchmove', (e) => this.determineDraw(e.touches[0]));
  }
